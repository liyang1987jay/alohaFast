package com.aloha.alohaFast.core.persistence.entity;
...
/**
 * @author liyang
 * @packageNaem com.aloha.alohaFast.core.persistence.entity
...
public class OperationLog extends Model<OperationLog> implements Serializable {
    private static final long serialVersionUID = -4617515915657448974L;
