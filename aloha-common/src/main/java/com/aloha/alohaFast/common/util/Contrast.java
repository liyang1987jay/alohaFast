...
import com.aloha.alohaFast.common.constant.dictmap.factory.DictFieldWarpperFactory;
...
public class Contrast {
    ...
    /**
     * @methoe_name:contrastObj
     * @param: 
     * @describe:  比较两个对象,并返回不一致的信息
     * @description 
     * @author liyang
     * @return 
        ...
        try {
            ...
            for (Field field : fields) {
                ...
                if (o1 instanceof Date) {
                    o1 =AlohaDateUtil.formatDate((Date) o1);
                }
     ...
     * @methoe_name:contrastObj
     * @param: 
     * @describe: 比较两个对象pojo1和pojo2,并输出不一致信息
     * @description 
     * @author liyang
     * @return 
     * creat_date: 2017/10/22
    ...
    /**
     * @methoe_name:parseMutiKey
     * @param: 
     * @describe: 解析多个key(逗号隔开的)
     * @description 
     * @author liyang
     * @return 
     * creat_date: 2017/10/22
